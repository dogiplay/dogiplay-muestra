...
export default function HrGlobal(props) {
  ...
  return (
    <View
      ...
      {...getOverrideProps(overrides, "HrGlobal")}
      {...rest}
    >
      <View
        width="132px"
      ...
      <Image
        ...
        objectFit="cover"
        src={jugadores?.foto}
        {...getOverrideProps(overrides, "pexels-tima-miroshnichenko-5184682 1")}
      ></Image>
      <Text
        fontFamily="Inter"
        fontSize="12px"
      ...
      <Text
        ...
        {...getOverrideProps(overrides, "LIGA MEXICANA DE BEISBOL")}
      ></Text>
      <Icon
        width="39.5px"
        height="39.47px"

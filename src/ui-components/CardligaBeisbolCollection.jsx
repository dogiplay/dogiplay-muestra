...
import CardligaBeisbol from "./CardligaBeisbol";
...
export default function CardligaBeisbolCollection(props) {
  ...
  return (
    <div>
      <Collection
        ...
        {...getOverrideProps(overrides, "CardligaBeisbolCollection")}
        {...rest}
      >
        {(item, index) => {
          if (loading) {

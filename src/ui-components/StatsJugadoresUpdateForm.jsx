...
export default function StatsJugadoresUpdateForm(props) {
  const {
    id: idProp,
    statsJugadores: statsJugadoresModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = statsJugadoresRecord
      ? { ...initialValues, ...statsJugadoresRecord }
      : initialValues;
    setIdjugador(cleanValues.idjugador);
    setIdpartido(cleanValues.idpartido);
    ...
    setBascanastas(cleanValues.bascanastas);
    setBaspuntos(cleanValues.baspuntos);
    ...
    setBeicarrerasproducidas(cleanValues.beicarrerasproducidas);
    setFuttarjetasamarillas(cleanValues.futtarjetasamarillas);
    setFuttarjetasrojas(cleanValues.futtarjetasrojas);
    setErrors({});
  };
  const [statsJugadoresRecord, setStatsJugadoresRecord] = React.useState(
  ...
  React.useEffect(() => {
    ...
    queryData();
  }, [idProp, statsJugadoresModelProp]);
  React.useEffect(resetStateValues, [statsJugadoresRecord]);
  const validations = {
    idjugador: [],
    idpartido: [],
    iddeporte: [],
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "StatsJugadoresUpdateForm")}
      {...rest}
    >
      <TextField
        label="Idjugador"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || statsJugadoresModelProp)}

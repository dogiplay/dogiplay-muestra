...
export default function EquiposUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setIdcategoria(cleanValues.idcategoria);
    setManager(cleanValues.manager);
    setFutgolesfavor(cleanValues.futgolesfavor);
    setFutgolescontra(cleanValues.futgolescontra);
    setPartidosjugados(cleanValues.partidosjugados);
    setPartidosganados(cleanValues.partidosganados);
    setPartidosperdidos(cleanValues.partidosperdidos);
    setPartidosempatados(cleanValues.partidosempatados);
    setPuntos(cleanValues.puntos);
    setPosiciontabla(cleanValues.posiciontabla);
    setPatrocinador(cleanValues.patrocinador);
    setBeicarreras(cleanValues.beicarreras);
    setBeihr(cleanValues.beihr);
    setClave_liga(cleanValues.clave_liga);
    setFutdifgoles(cleanValues.futdifgoles);
    setErrors({});
  };

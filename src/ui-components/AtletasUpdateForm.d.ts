...
export declare type AtletasUpdateFormInputValues = {
    nombre?: string;
    foto?: string;
    equipoclub?: string;
    disciplina?: string;
...
export declare type AtletasUpdateFormValidationValues = {
...
export declare type AtletasUpdateFormOverridesProps = {
    AtletasUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type AtletasUpdateFormProps = React.PropsWithChildren<{
    overrides?: AtletasUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    atletas?: Atletas;
    onSubmit?: (fields: AtletasUpdateFormInputValues) => AtletasUpdateFormInputValues;
    onSuccess?: (fields: AtletasUpdateFormInputValues) => void;
    onError?: (fields: AtletasUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: AtletasUpdateFormInputValues) => AtletasUpdateFormInputValues;
    onValidate?: AtletasUpdateFormValidationValues;
} & React.CSSProperties>;
export default function AtletasUpdateForm(props: AtletasUpdateFormProps): React.ReactElement;

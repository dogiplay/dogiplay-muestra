...
import { listJugadores as listJugadoresMutation } from "../graphql/queries";
import { listJugadores as listJugadores } from "../graphql/queries";
    ...
    while ((newCache.length < cacheUntil || !isPaginated) && newNext != null) {
      ...
      const result = (
        await client.graphql({
          query: listJugadores.replaceAll("__typename", ""),
          variables,
        })
      ).data.listJugadores;

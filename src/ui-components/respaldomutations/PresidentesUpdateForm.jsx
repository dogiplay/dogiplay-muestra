...
import { getPresidentes as getPresidentesMutations} from "../graphql/queries";
import { updatePresidentes as updatePresidentesMutations} from "../graphql/mutations";
const client = generateClient();
export default function PresidentesUpdateForm(props) {
  const {
    id: idProp,
    presidentes: presidentesModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = presidentesRecord
      ? { ...initialValues, ...presidentesRecord }
      : initialValues;
    ...
    setNotorneos(cleanValues.notorneos);
    setErrors({});
  };
  const [presidentesRecord, setPresidentesRecord] =
    React.useState(presidentesModelProp);
  React.useEffect(() => {
    ...
    queryData();
  }, [idProp, presidentesModelProp]);
  React.useEffect(resetStateValues, [presidentesRecord]);
  const validations = {
    idliga: [],
    nombre: [],
    alias: [],
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "PresidentesUpdateForm")}
      {...rest}
    >
      <TextField
        label="Idliga"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || presidentesModelProp)}

...
export default function PartidosUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setEquipo1(cleanValues.equipo1);
    setEquipo2(cleanValues.equipo2);
    setHora(cleanValues.hora);
    setResultado_equipo1(cleanValues.resultado_equipo1);
    setResultado_equipo2(cleanValues.resultado_equipo2);

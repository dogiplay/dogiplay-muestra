...
export default function LiguillaCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPosicion_cuartos(initialValues.posicion_cuartos);
    setPosicion_semi(initialValues.posicion_semi);
    setPosicion_final(initialValues.posicion_final);
    setLogo(initialValues.logo);
    setEquipo(initialValues.equipo);
    setCategoria(initialValues.categoria);
    setNombre_liga(initialValues.nombre_liga);
    setClave_final(initialValues.clave_final);
    setClave_semi(initialValues.clave_semi);
    setClave_cuartos(initialValues.clave_cuartos);
    setErrors({});
  };
  const validations = {
    clave_liga: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Liguilla(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "LiguillaCreateForm")}
      {...rest}
    >
      <TextField
        label="Clave liga"
